...
note:
    the write call will lock inode.i_mutex to be sure write is atomic.
    when file is opened with O_APPEND, the call will read the file size again to be sure the writing file is serialable.
